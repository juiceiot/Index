...
# Example:
# sh create-illuminator.sh [Label] [DeviceName] [Port]
# sh create-illuminator.sh "Illuminator1" illuminator1 ttyUSB0 
...
# Set up mobile UI
sh create-illuminator-ui.sh $DEVICE_LABEL $DEVICE_NAME $DEVICE_PORT && \
