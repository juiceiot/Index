...
# Example:
# sh upload-meter-sketch.sh ttyUSB0
...
echo "Uploading meter sketch"

echo "Serial port: $SERIAL_PORT"

BASE_PATH="sketches/meter/VoltageCurrentMAX471SensorCalibratedSerial"

cd $BASE_PATH

SKETCH_PATH="src/VoltageCurrentMAX471SensorCalibratedSerial/VoltageCurrentMAX471SensorCalibratedSerial.ino"
