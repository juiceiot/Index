...
# Example:
# sh upload-protector-sketch.sh ttyUSB0
...
echo "Uploading protector sketch"

echo "Serial port: $SERIAL_PORT"

BASE_PATH="sketches/protector/VoltageCurrentMAX471SensorCalibratedSwitch"

cd $BASE_PATH

SKETCH_PATH="src/VoltageCurrentMAX471SensorCalibratedSwitch/VoltageCurrentMAX471SensorCalibratedSwitch.ino"
